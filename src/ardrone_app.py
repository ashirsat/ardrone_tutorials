...
class DroneVideoDisplay(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        btn = QtGui.QPushButton('Toggle', self)
        btn.setGeometry(300, 300, 50, 50)
        ...
        # Toggle the video stream between front and bottom camera
        btn.clicked.connect(self.ToggleCam)
    ...
    def ToggleCam(self):
        # Subscribe to the togglecam service
        ...
        try:
            ...
            print "Service Call failed to %s"%e
