...
class Navdata_GUI(QtGui.QMainWindow):
    ...
    def initGUI(self):
        ...
        """ Setting up the publisher for the ardrone battery percentage """
        self.bat_publish = rospy.Publisher('/ardrone/battpercent', Int8, queue_size=10)
        ...
        self.navdata_rot_z.setGeometry(self.navdata_rot_x_base_cord ,self.navdata_rot_y_base_cord + 2*self.box_height,
                                   self.box_width, self.box_height)
        self.navdata_rot_z.setFont(QtGui.QFont(self.font_style, self.font_weight))
        ...
        self.navdata_alt_reading.setGeometry(self.navdata_alt_base_x_cord + self.box_width, self.navdata_alt_base_y_cord
                                             , self.box_width +50, self.box_height)
    ...
    def NavdataCallBack(self):
        if self.navdata.state is 0:
             return 'Emergency'
        elif self.navdata.state is 1:
             return 'Inited'
        elif self.navdata.state is 2:
             return 'Landed'
        elif self.navdata.state is 3:
             return 'Flying'
        elif self.navdata.state is 4:
             return 'Hovering'
        elif self.navdata.state is 5:
             return 'Test'
        elif self.navdata.state is 6:
             return 'Taking Off'
        elif self.navdata.state is 7:
             return 'Go To Hover'
        elif self.navdata.state is 8:
             return 'Landing'
        elif self.navdata.state is 9:
            return 'Looping'
        else:
             return 'Unknown'
    ...
    def RedrawCallback(self):
        ...
        self.navdata_alt_reading.setText("%.2f"%(self.navdata.altd))
        ################################################################################################################
        """ Defining the status bar for getting the battery percent and the drone state """
        self.statusMessage = '{} (Battery: {}%)'.format(self.NavdataCallBack(), int(self.navdata.batteryPercent))
        self.statusBar().showMessage(self.statusMessage)
        self.statusBar().setFont(QtGui.QFont(self.font_style, 12))
        self.bat_publish.publish((self.navdata.batteryPercent))
        # finally:
